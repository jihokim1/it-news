    ...
    <div className="container mx-auto px-4 py-8 max-w-screen-xl flex flex-col md:flex-row gap-8 items-start">
      ...
      <div className="flex-1 space-y-2 text-xs md:text-[13px] leading-relaxed">
          ...
          <p>
            ...
            <span className="font-bold text-gray-300">전화:</span> 070-8058-9573<span className="mx-2 text-gray-700">|</span>
            <span className="font-bold text-gray-300">등록번호:</span> 서울 아56397 <span className="mx-2 text-gray-700">|</span>
